...
This gives us a set of training data for actual training purposes having 13737 observations, or about 70% of the total training data, in a traingTrainingData.  We also have 5885 observations of training data, in testTrainingData, that we will use to test our model before final application on the downloaded test data that is in testingData.  
