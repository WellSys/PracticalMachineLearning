...
We can see that we eliminated 100 columns from the trainingData data set.  The testingData data set appears to be clean.
...
We will first build the model on the training portion of the training data using the randomForest alghorith.
